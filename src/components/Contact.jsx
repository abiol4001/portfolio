  ...
  return (
    <>
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="h-[100%] w-[100%] mx-auto flex flex-col md:flex-row gap-y-14 items-center px-4 text-center md:text-left lg:px-[100px]"
      >
        <motion.div
          variants={variants}
          className="lg:flex-1 flex flex-col gap-3 md:gap-5"
        >
          <motion.h1
            variants={variants}
            className="text-5xl lg:text-9xl mt-16 lg:mt-0 lg:leading-[120px]"
          >
            Let's work together
          </motion.h1>
          <div className="hidden lg:block">
            <motion.div variants={variants}>
              ...
              <a
                href="mailto:aaoyewale07@gmail.com"
                className="text-sm font-[300]"
              >
                aaoyewale07@gmail.com
              </a>
            </motion.div>
            <motion.div variants={variants}>
        ...
        <div className="lg:flex-1 relative w-full">
          <motion.div
            ...
            className="stroke-white absolute mx-auto -z-10 w-full flex justify-center"
          >
            <svg
              fill="none"
              width="100%"
          ...
          <motion.form
            ...
            noValidate
            className="flex flex-col gap-3 md:gap-4 text-left px-4 md:px-10 lg:px-16 z-50"
          ...
          >
            ...
            >
              ...
              <input
                type="name"
                className="border-[1px] border-white h-[43px] rounded-[5px] w-full outline-none px-3 font-light"
                name="name"
                placeholder="Name"
                {...register("name")}
              />
            ...
            >
              ...
              <textarea
                type="message"
                className="border-[1px] border-white rounded-[5px] w-full outline-none px-3 py-2 font-light"
                rows={8}
                name="message"
                placeholder="Message"
                {...register("message")}
            ...
            <button className="bg-white h-[45px] text-black rounded-[5px] flex justify-center items-center gap-1">
              Submit <Send size={15} />
            </button>
          </motion.form>
        </div>
