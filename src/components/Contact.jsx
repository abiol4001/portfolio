...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="h-[100%] w-[100%] mx-auto flex items-center lg:px-[100px]"
    >
      <motion.div variants={variants} className="flex-1 flex flex-col gap-5">
        <motion.h1 variants={variants} className="text-9xl leading-[120px]">
          Let's work together
        </motion.h1>
      ...
      <div className="flex-1 relative">
        <motion.div
          ...
          className="stroke-white absolute mx-auto -z-10"
        >
          <svg
            fill="none"
            width="600px"
        ...
        <motion.form
          ...
          noValidate
          className="flex flex-col gap-4 md:px-10 lg:px-16 z-50"
        ...
        >
          ...
          <button className="bg-white h-[45px] text-black rounded-[5px]">
            Submit
          </button>
        </motion.form>
      </div>
